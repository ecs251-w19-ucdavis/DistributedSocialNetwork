...
\\
We are going to keep enhancing the sentiment analysis function to get a more convincing result in the next following week, and we are interesting in another function that relate with sentiment analysis which is about fake news analysis function, but there are many uncertain things for now.
